...
**[Hello_Rails_Backend]** is a Hello world project to learn about rails & react in two apps.
...
```sh
  cd my-folder
  git clone git@github.com:myaccount/hello-rails-backend.git
```
...
- Twitter: [@twitterhandle](https://twitter.com/hmunish05)
